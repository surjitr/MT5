...
input double InpBE_ATR                 = 3.0;           // Move SL to Breakeven at x*ATR profit
input double InpTrailTrigger_ATR       = 3.5;           // Start Trailing at x * ATR profit
input double InpTrailDist_ATR          = 1.5;           // Trail Distance = x * ATR
